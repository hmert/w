...
(function (root, factory) {
  ...
  function _enable() {
    ...
    fullscreenIconClickHandler = function() {
      enableFullScreen.call(self, this);
    };
   ...
   * @param {Object} link
   */
  function enableFullScreen(link) {
    var self = this;
  ...
  function enableFullScreen2() {
    ...
    //create overlay layer
    var overlayLayer = document.createElement('div');
    overlayLayer.className = 'widearea-overlayLayer light';
